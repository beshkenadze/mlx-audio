...
class AcousticEncoder(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.conv1 = WNConv1d(1, 64, kernel_size=7, padding=3)
        ...
        self.snake = Snake1d(2048)
        self.conv2 = WNConv1d(2048, 256, kernel_size=3, padding=1)
...
class AcousticDecoder(nn.Module):
    ...
    Matches keys: acoustic_decoder.conv1, .block.N.*, .snake, .conv2
    """
    ...
    def __init__(self):
        super().__init__()
        self.conv1 = WNConv1d(256, 1024, kernel_size=7, padding=3)
        ...
        self.snake = Snake1d(32)
        self.conv2 = WNConv1d(32, 1, kernel_size=7, padding=3)
...
class VectorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.project_in = nn.Linear(latent_dim, codebook_dim, bias=False)
        self.codebook = nn.Embedding(codebook_size, codebook_dim)
        self.project_out = nn.Linear(codebook_dim, latent_dim, bias=False)
